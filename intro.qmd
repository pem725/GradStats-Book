...
3.  Do you have a job that requires you to make decisions based upon data?
4.  Do you vote?
5.  Can you read English?
6.  Do you have a computer you can run computer code (e.g., R, python, etc.)?
7.  Do you have a desire to learn how to quantify your uncertainty?
...
3. Code:  statistical software code to demonstrate the concepts
4. Challenges:  exercises to test your understanding of the concepts

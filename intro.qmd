...
# Define cylinder for the helix body
#helix <- cylinder3d(r = radius, h = height, sides = 30)

# Define rotation for the helix spiral
theta <- seq(from = 0, to = 2*pi*n_turns, length.out = 100)
rot.mat <- matrix(c(cos(theta), -sin(theta), 0, 
                    sin(theta),  cos(theta), 0,
                    0,             0,           1), nrow = 3, ncol = 3)

# Apply rotation to each point in the cylinder
#helix$v <- t(rot.mat) %*% t(helix$v)

#plot3d(helix, shade = FALSE, col = "blue")  # adjust color and shading

# Add labels and title (optional)
#text3d(x = 0, y = 0, z = height + 0.5, "Height", size = 8)
#text3d(x = radius + 0.5, y = 0, z = 0, "Radius", size = 8)
#title3d("Single Helix")

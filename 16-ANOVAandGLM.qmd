...
You now hold the unifying idea of the whole enterprise: the General Linear Model. Correlation, t-tests, regression, ANOVA, ANCOVA - all one model wearing different outfits. We build these coding schemes by hand in the [dedicated coding chapter](19-coding.qmd); for the definitive treatment, see Cohen, Cohen, West, and Aiken [@aiken_applied_2002] and the accessible comparison of dummy and effects coding in Alkharusi [@alkharusi_categorical_2012]; for analysis of variance specifically, Iversen and Norpoth [@iversen_analysis_1987] remains a compact classic. From here, the road leads into the specific ANOVA designs - one-way, factorial, repeated measures - each of which is, you will not be surprised to learn, just another coded regression.

...
plot([plot(mlb.year, mlb[!, c], title = String(c), legend = false)
      for c in [:K_PA, :BB_PA, :HR_PA]]..., layout = (1, 3))
```
### Python
```{python}
import pandas as pd
...
plt.barh(nfl.team, nfl.rate_bust_a, color="0.35")
plt.xlabel("Bust rate (no Pro Bowl)")

...
```{r}
#| label: fig-heights
#| fig-cap: "Five hundred simulated adult heights, with the normal curve they were drawn from. The bars are the sample; the curve is the model."
set.seed(20)
...
### R
```{r}
#| label: fig-skew-normal
#| fig-cap: "A skew-normal with alpha = 6 - still a bell, but leaning right. Set alpha to zero and the red curve becomes the ordinary normal."
set.seed(21)
...
#| fig-cap: "Four named distributions, each carrying its theoretical curve. Normal and Uniform are continuous, so the curve is an unbroken line; Binomial and Poisson are discrete, so their probability sits on the whole numbers as points."
set.seed(22)
...
#| fig-cap: "The standard normal density. The height of the curve is not a probability - probability is the area under a stretch of it."

...
*
* Open this file, edit the CD line in STEP 1 below, and Run All. It defines a
* macro called !bookdata, after which any chapter's data is one line away:
*
*     !bookdata name = "ch06-study".
*
* You need the WHOLE book folder, not just this file - the macro reads the
* .sps and .csv files under data/. Get everything at once from
* https://github.com/pem725/GradStats-Book/archive/refs/heads/main.zip

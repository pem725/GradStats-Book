...
#| label: fig-spread
#| message: false
#| fig-cap: "Two distributions with the same mean and very different spread, each with its own theoretical curve. The spread is the uncertainty."
...
df = CSV.read("data/sim/ch03-x.csv", DataFrame)
...
```{python}
import pandas as pd
df = pd.read_csv("data/sim/ch03-x.csv")
